...
def upgrade():
    op.execute("UPDATE \"user\" SET additional_info='<unknown>' WHERE additional_info IS NULL")
    op.execute("UPDATE \"group\" SET private=FALSE WHERE private IS NULL")
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('api_key', 'issued_by',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('api_key', 'issued_on',
               existing_type=postgresql.TIMESTAMP(),
               nullable=False)
    op.alter_column('group', 'private',
    ...
    op.alter_column('user', 'email',
               ...
               nullable=False)
    op.alter_column('user', 'feed_quality',
